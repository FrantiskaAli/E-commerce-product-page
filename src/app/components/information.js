...
export default function Info({onPlus, onMinus,cart,addToCart }) {
    return (
        <section className="md:w-2/4 self-start md:pl-10  md:p-2 md:pt-16 px-8 flex flex-col justify-center">
            <article >
                <h1 className="text-md uppercase font-bold text-orange-500 mb-6 font-all tracking-wider">Sneaker Company</h1>
            ...
            <article className="flex min-w-full justify-between md:flex-row flex-col mt-14">
                ...
                <button onClick={addToCart} className="bg-orange-500 md:w-3/5 md:pt-4 place-content-center md:py-auto py-4 px-20 rounded-xl hover:opacity-75 flex shadow-2xl md:px-12 font-all"> 
