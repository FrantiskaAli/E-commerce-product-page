        ...
        <section className="w-2/4 flex flex-col justify-center px-14 py-12">
            ...
            <article className="flex min-w-full justify-between mt-14">
                <section className="flex bg-gray-100 w-1/3 justify-between py-2 px-4 rounded">
                    ...
                    <span className="font-extrabold text-4xl text-yellow-600 hover:text-yellow-400 leading-none cursor-pointer">-</span>

                    <span className="font-extrabold text-xl mt-2 leading-none">0</span>
         
                    <span className="font-extrabold text-3xl hover:text-yellow-400 text-yellow-600 leading-none cursor-pointer">+</span>
                </section>
                <button className="bg-yellow-400  pt-4 place-content-center  px-20 rounded-2xl hover:opacity-50 flex shadow-lg"> 
