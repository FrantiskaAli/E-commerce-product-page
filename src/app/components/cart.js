        ...
        <section  className="h-fit md:w-1/4 md:top-22 md:right-20 left-2 top-24 text-center p-4 shadow-lg absolute bg-white rounded-xl">
            ...
            <section>
                <article className="flex items-center p-4 ">
                    ...
                    <p className="text-gray-400 text-left px-4">Fall Limited Edition Sneakers <br /> $125.00 x {cart} ${125.00 * cart} </p>
                ...
                <button className="bg-yellow-400 w-full rounded-lg py-4 my-2 hover:bg-yellow-600 hover:cursor-pointer  text-white font-bold ">Checkout</button>
            </section>
        </section>
    )
