...
export default function Navbar({ cartShow, cartActive, dot }) {
    ...
    return (
        <nav className="min-w-screen pt-8 md:pt-12 flex  px2 flex-nowrap justify-between border-b content-end md:content-center flex-shrink-0 border-gray-300 sticky top-0 bg-white z-20">
            ...
            <ul className={nav.display ? "flex min-w-80 h-full w-2/5 mr-36 justify-between font-all" : "hidden"}>
                <li className="hover:font-bold hover:cursor-pointer hover:border-b-4 h-full hover:border-orange-500  flex-shrink-0 w-1/5 pb-14 text-center">Collections</li>
                <li className="hover:cursor-pointer hover:border-b-4 hover:border-orange-500 flex-shrink-0 w-1/5 pb-4 text-center hover:font-bold">  Men</li>
                <li className="hover:border-b-4 hover:cursor-pointer hover:border-orange-500 flex-shrink-0 w-1/5 pb-4 text-center hover:font-bold"> Women</li>
                <li className="hover:border-b-4 hover:cursor-pointer hover:border-orange-500 flex-shrink-0 w-1/5 pb-4 text-center hover:font-bold"> About</li>
                <li className="hover:border-b-4 hover:cursor-pointer hover:border-orange-500 flex-shrink-0 w-1/5 pb-4 text-center hover:font-bold"> Contact</li>
            </ul>
